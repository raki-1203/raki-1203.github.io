...
- 일반화 성능을 높이는게 목적
    ...
    ![]({{site.url}}/assets/images/boostcamp/2021-08-10-10-07-50.png)
...
![]({{site.url}}/assets/images/boostcamp/2021-08-10-10-10-19.png)
...
![]({{site.url}}/assets/images/boostcamp/2021-08-10-10-15-34.png)
...
- 내가 minimize 하는 값은 한가지 값인데 이 값이 사실은 3가지 component 로 이루어져 있어서 이 3개 중에 각각을 minimize 하는게 아니라 하나가 줄어들면 하나가 커질 수 밖에 없다는것을 의미
    ...
    ![]({{site.url}}/assets/images/boostcamp/2021-08-10-10-19-33.png)
...
![]({{site.url}}/assets/images/boostcamp/2021-08-10-10-29-33.png)
...
- sharp minimizer 보다 flat minimizer 에 도달하는게 더 좋다
    ...
    ![]({{site.url}}/assets/images/boostcamp/2021-08-10-10-37-26.png)
...
![]({{site.url}}/assets/images/boostcamp/2021-08-10-10-40-18.png)
...
![]({{site.url}}/assets/images/boostcamp/2021-08-10-10-43-10.png)
