...
![]({{site.url}}/assets/images/c45334d2.png)
...
![]({{site.url}}/assets/images/b8badfe1.png)

**구현(끼워맞추기)**

![]({{site.url}}/assets/images/f472cb2e.png)

코드로 구현하면

![]({{site.url}}/assets/images/7d4220e0.png)

**구현(실제)**

![]({{site.url}}/assets/images/0a0a6a2c.png)

### 2.2 Architecture config

![]({{site.url}}/assets/images/76cc1a30.png)

**다양한 Backbone model**

![]({{site.url}}/assets/images/2f2a5ef8.png)

특정 data structure 에 block 들을 넣어서 모델을 "조립" 할 수 있을까? = block 들을 임의로 쌓아서 모델을 "생성" 할 수 있을까?

![]({{site.url}}/assets/images/2d6dacb4.png)

![]({{site.url}}/assets/images/7132d8d8.png)

![]({{site.url}}/assets/images/7472303f.png)

**Prerequisite: Optuna search space[1]**

1. Categorical
  ![]({{site.url}}/assets/images/976ab742.png)
2. Continuous
  ![]({{site.url}}/assets/images/be55d1c6.png)
3. Integer
  ![]({{site.url}}/assets/images/9d518d80.png)
4. Conditional(⭐️)
  ![]({{site.url}}/assets/images/834aade9.png)

**Custom search space 구성하기: 예시**

![]({{site.url}}/assets/images/e272248b.png)
...
- 아래처럼 모듈 block 으로 생성된 네트워크 구조는 고정함
  ...
  ![]({{site.url}}/assets/images/02ebb762.png)
...
- N, NC, RC 각각 고정 파라미터로 sample, 모델을 구성
  ...
  ![]({{site.url}}/assets/images/9589a622.png)
...
![]({{site.url}}/assets/images/d2170d9f.png)

### 3.1 yam 에서 Model 만들기 구조

![]({{site.url}}/assets/images/f1c8af57.png)

![]({{site.url}}/assets/images/c4a6fa91.png)

![]({{site.url}}/assets/images/39e2dc93.png)

![]({{site.url}}/assets/images/8a54cc3d.png)

![]({{site.url}}/assets/images/eddf5a31.png)

### 3.2 yaml 에서 Model 만들기 parsing 코드

![]({{site.url}}/assets/images/68d5c472.png)

### 3.2 yaml 에서 Model 만들기 parsing 코드 - 반복 횟수

![]({{site.url}}/assets/images/8b16f22f.png)

depth_multiply : 깊이를 조절하겠다는 의미

### 3.2 yaml 에서 Model 만들기 parsing 코드 - 모듈 생성기

![]({{site.url}}/assets/images/0a343bbb.png)

![]({{site.url}}/assets/images/caa6d7a3.png)

![]({{site.url}}/assets/images/b828ee81.png)
...
1. 구현체 추가(https://github.com/pytorch/vision/blob/master/torchvision/models/mobilenetv2.py)
  ![]({{site.url}}/assets/images/16d44a49.png)

2. Module generator 인터페이스 작업
  ![]({{site.url}}/assets/images/94fc0d12.png)
  ![]({{site.url}}/assets/images/ca4b3e9d.png)
